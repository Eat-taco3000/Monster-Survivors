...
class Enemy extends Entity {
  ...
  takeDamage(amount, knockbackAngle, knockbackForce, game) {
    ...
    knockbackAngle = Number.isFinite(Number(knockbackAngle)) ? Number(knockbackAngle) : 0;
    knockbackForce = Number.isFinite(Number(knockbackForce)) ? Number(knockbackForce) : 0;
  ...
  checkContactDamage(player, game) {
    ...
    if (player.isPhasing) return false;
