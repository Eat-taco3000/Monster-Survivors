...
const Input = {
  ...
  init() {
    window.addEventListener('keydown', (e) => {
      ...
      // Prevent default for game keys (include KeyE and sprint)
      if (['ArrowUp','ArrowDown','ArrowLeft','ArrowRight','Space','KeyW','KeyA','KeyS','KeyD','KeyE','KeyP','Escape','ShiftLeft','ShiftRight'].includes(e.code)) {
        e.preventDefault();
      }
    });
